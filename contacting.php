...
// $QUERY='INSERT INTO reviews ("fullname","email", "hearAboutUs", "reasonForFranchise") VALUES('.$data['fullname']",'".$data['email']."',".$data['howYouFoundUs'].",'".$data['whyShouldYouFranchise']."');";
// $db->exec($QUERY);
...
<body>
  ...
  <?php 
         echo '<h1 class="title is-2 is-center">Thanks for contacting us</h1>';
         print("Your information: <br> Full Name: ".$data['fullname']."<br>"."Email: ".$data['email'])
        ?>          
</body>
</html>